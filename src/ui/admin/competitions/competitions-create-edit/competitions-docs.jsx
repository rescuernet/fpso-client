            ...
            AdminNewsStore.news_tmp_docs_old.map((i,index)=>(
                <div className={classes.docsItem}>
                    <TextField
                        ...
                        rowsMax={10}
                    />
                    <a href={`${API_URL}/${id}/docs/${AdminNewsStore.news_tmp_docs_old[index].doc}`} target={'_blank'} rel="noreferrer">
            ...
            AdminNewsStore.news_tmp_docs_new.map((i,index)=>(
                <div className={classes.docsItem}>
                    <TextField
                        ...
                        rowsMax={10}
                    />
                    <a href={API_URL + '/' + AdminNewsStore.news_tmp_docs_new[index].doc} target={'_blank'} rel="noreferrer">
